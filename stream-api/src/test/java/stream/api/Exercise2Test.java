...
public class Exercise2Test extends ClassicOnlineStore {
    ...
    public void sortByAge() {
         ...
         */
        Stream<Integer> sortedAgeStream = customerList.stream().map(Customer::getAge).sorted(Comparator.comparing(Integer::intValue));
    ...
    public void descSortByAge() {
         ...
         */
        Comparator<Integer> descOrder = (s1,s2) -> s2-s1;
